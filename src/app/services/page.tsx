...
export const metadata = {
  title: "Services",
  description: "Explore Dento dental services, treatments, pricing, and care details.",
};
          ...
          <Container>
            <div className="max-w-3xl">
              ...
              <p className="mt-5 body-lg text-muted-foreground">
                Browse the treatments our team provides, then open any service to see the visit flow, benefits, and starting price.
              </p>
            </div>
