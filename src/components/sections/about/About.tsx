  ...
  return (
    <Section id="about" spacing="lg">
      <div className="grid gap-14 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:gap-20">
        <FadeIn className="relative min-h-105 overflow-hidden rounded-[1.5rem] bg-secondary">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-[#142b35]/65 via-transparent to-transparent" />
